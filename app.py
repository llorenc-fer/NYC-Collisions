...
def add_bg_from_url():
    st.markdown(
         ...
         <style>
         .stApp {{
             background-image: url("https://github.com/llorenc-fer/NYC-Collisions/blob/main/photo_2023-02-11_12-57-38.jpg?raw=true");
...
data = data[data['date/time'].dt.hour.between(hour[0], hour[1])]

st.markdown("Vehicle collisions between %i:00 and %i:00" % (hour[0], hour[1]))
